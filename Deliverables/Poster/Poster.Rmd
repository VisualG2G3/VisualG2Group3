...
Car GPS movement path shown on the city map of Abila: The left plot represents different dates by colors, while the right one representing different time slot by different colors.
...
```{r out.width="100%"}
knitr::include_graphics("images/dailydealztable.png")
```
