...
Then we do some exploration for the data and check the missing values by using the code chunk below. Only *CarID* in car-assignments.cs has 9 missing values.
